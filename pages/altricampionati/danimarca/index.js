...
let showData = [];
try {
  showData = require("../../../data/danimarca/ShowDanimarca.json");
} catch {
  console.warn("⚠️ ShowDanimarca.json non trovato");
}
...
export default function Danimarca() {
  ...
  return (
    <Layout>
      <Head>
  <title>Danimarca Superliga: Pronostici & Statistiche | SportWhisp</title>
  <meta
    name="description"
    content="Pronostici statistici Superliga danese: percentuali 1-X-2, Under/Over, Gol/NoGol e risultati previsti."
  />
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="https://sportwhisp.it/altricampionati/danimarca" />
  <meta property="og:title" content="Danimarca Superliga: Pronostici & Statistiche | SportWhisp" />
  <meta
    property="og:description"
    content="Previsioni Superliga danese basate su modelli statistici: probabilità esito, Under/Over e Gol/NoGol."
  />
