...
export default function ClassificaSpa2() {
  ...
  return (
    <Layout>
      <Head>
        <title>Classifica LaLiga Hypermotion (Segunda División) | SportWhisp</title>
        <meta
          name="description"
          content="Classifica LaLiga Hypermotion aggiornata: punti, differenza reti, rendimento casa/trasferta e forma. Statistiche aggiornate su SportWhisp."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sportwhisp.it/secondediv/spa2/classifica" />
        <meta
          property="og:title"
          content="Classifica LaLiga Hypermotion (Segunda División) | SportWhisp"
        />
        <meta
          property="og:description"
          content="Tabella Segunda División aggiornata con punti, diff reti, casa/trasferta e forma. Statistiche complete su SportWhisp."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sportwhisp.it/secondediv/spa2/classifica" />
        <meta property="og:image" content="https://sportwhisp.it/Logo.png" />
      </Head>

      <h1>Classifica LaLiga Hypermotion {season}</h1>
      <p>
        La <strong>Segunda División</strong> (LaLiga Hypermotion) è un torneo lungo e competitivo,
        con piazze storiche e giovani di qualità. Qui trovi la classifica aggiornata con punti,
        differenza reti, rendimento casa/trasferta e stato di forma recente, per leggere al meglio
        la corsa a promozione diretta, playoff e salvezza.
      </p>
