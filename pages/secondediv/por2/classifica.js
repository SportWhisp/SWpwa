...
export default function ClassificaPor2() {
  ...
  return (
    <Layout>
      <Head>
        <title>Classifica Liga Portugal 2 (Segunda Liga) | SportWhisp</title>
        <meta
          name="description"
          content="Classifica Liga Portugal 2 aggiornata: punti, differenza reti, rendimento casa/trasferta e forma. Statistiche aggiornate su SportWhisp."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sportwhisp.it/secondediv/por2/classifica" />
        <meta
          property="og:title"
          content="Classifica Liga Portugal 2 (Segunda Liga) | SportWhisp"
        />
        <meta
          property="og:description"
          content="Tabella Liga Portugal 2 aggiornata con punti, diff reti, casa/trasferta e forma. Statistiche complete su SportWhisp."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sportwhisp.it/secondediv/por2/classifica" />
        <meta property="og:image" content="https://sportwhisp.it/Logo.png" />
      </Head>

      <h1>Classifica Liga Portugal 2 {season}</h1>
      <p>
        La <strong>Liga Portugal 2</strong> (Segunda Liga) è un campionato tecnico e combattuto:
        tra club storici e progetti in crescita, la corsa alla promozione e la lotta salvezza
        restano vive fino all’ultimo. Qui trovi la classifica aggiornata con punti, differenza reti,
