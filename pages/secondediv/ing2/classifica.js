...
export default function ClassificaIng2() {
  ...
  return (
    <Layout>
      <Head>
        <title>Classifica Championship Inghilterra | SportWhisp</title>
        <meta
          name="description"
          content="Classifica Championship aggiornata: punti, differenza reti, rendimento casa/trasferta e forma. Statistiche aggiornate su SportWhisp."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sportwhisp.it/secondediv/ing2/classifica" />
        <meta property="og:title" content="Classifica Championship Inghilterra | SportWhisp" />
        <meta
          property="og:description"
          content="Tabella Championship aggiornata con punti, diff reti, casa/trasferta e forma. Statistiche complete su SportWhisp."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sportwhisp.it/secondediv/ing2/classifica" />
        <meta property="og:image" content="https://sportwhisp.it/Logo.png" />
      </Head>

      <h1>Classifica Championship {season}</h1>
      <p>
        La <strong>Championship</strong> è uno dei tornei più intensi d’Europa: calendario fitto,
        stadi gremiti e club storici che inseguono il ritorno in Premier League. Qui trovi la
        classifica aggiornata con punti, differenza reti, rendimento casa/trasferta e stato di forma,
        per leggere al meglio la corsa a promozione diretta, playoff e salvezza.
      </p>
