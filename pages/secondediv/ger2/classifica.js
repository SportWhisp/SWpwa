...
export default function ClassificaGer2() {
  ...
  return (
    <Layout>
      <Head>
        <title>Classifica 2. Bundesliga Germania | SportWhisp</title>
        <meta
          name="description"
          content="Classifica 2. Bundesliga aggiornata: punti, differenza reti, rendimento casa/trasferta e forma. Statistiche aggiornate su SportWhisp."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sportwhisp.it/secondediv/ger2/classifica" />
        <meta property="og:title" content="Classifica 2. Bundesliga Germania | SportWhisp" />
        <meta
          property="og:description"
          content="Tabella 2. Bundesliga aggiornata con punti, diff reti, casa/trasferta e forma. Statistiche complete su SportWhisp."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sportwhisp.it/secondediv/ger2/classifica" />
        <meta property="og:image" content="https://sportwhisp.it/Logo.png" />
      </Head>

      <h1>Classifica 2. Bundesliga {season}</h1>
      <p>
        La <strong>2. Bundesliga</strong> è una delle seconde divisioni più spettacolari d’Europa:
        ritmi alti, stadi caldissimi e club storici alla rincorsa della promozione. Qui trovi la
        classifica aggiornata con punti, differenza reti, rendimento casa/trasferta e stato di forma,
        per orientarti tra lotta alla promozione, spareggio e salvezza.
      </p>
