...
export default function ClassificaIta2() {
  ...
  return (
    <Layout>
      <Head>
        <title>Classifica Serie B Italia | SportWhisp</title>
        <meta
          name="description"
          content="Classifica Serie B aggiornata: punti, differenza reti, rendimento casa/trasferta e forma. Statistiche aggiornate su SportWhisp."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sportwhisp.it/secondediv/ita2/classifica" />
        <meta property="og:title" content="Classifica Serie B Italia | SportWhisp" />
        <meta
          property="og:description"
          content="Tabella Serie B aggiornata con punti, diff reti, casa/trasferta e forma. Statistiche complete su SportWhisp."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sportwhisp.it/secondediv/ita2/classifica" />
        <meta property="og:image" content="https://sportwhisp.it/Logo.png" />
      </Head>

      <h1>Classifica Serie B {season}</h1>
      <p>
        La <strong>Serie B</strong> è il campionato dell’equilibrio e delle sorprese: tra la corsa
        alla promozione diretta, i playoff e la lotta salvezza, ogni punto conta. Qui trovi la
        classifica aggiornata con punti, differenza reti, rendimento casa/trasferta e stato di forma,
        per leggere al meglio gli scenari della stagione.
      </p>
