...
const LEAGUE = "italia";            // ✅ cartella della nazione
const SEASON = "2023-2024";         // ✅ stagione
const FILE_NAME = `standings-${LEAGUE}-${SEASON}.json`;

export default function ClassificaItaliaAdmin() {
  ...
  useEffect(() => {
    fetch(`/api/readData?league=${LEAGUE}&file=${FILE_NAME}`)
      ...
      .then((data) => {
        ...
        // ✅ Parsing dati SOLO per API-Football
  ...
  return (
    <Layout>
      <h1>Classifica Serie A {SEASON} (ADMIN)</h1>
