...
const LEAGUE = "germania";           // ✅ cartella della nazione
const SEASON = "2025-2026";          // ✅ stagione
const FILE_NAME = `standings-${LEAGUE}-${SEASON}.json`;

export default function ClassificaGermania2025_2026() {
  ...
  useEffect(() => {
    fetch(`/api/readData?league=${LEAGUE}&file=${FILE_NAME}`)
      ...
      .then((data) => {
        ...
        // ✅ Parsing SOLO per dati football-data.org
  ...
  return (
    <Layout>
      <h1>Classifica Bundesliga {SEASON} (ADMIN)</h1>
